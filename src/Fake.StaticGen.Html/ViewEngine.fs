...
// adapted in this project to aid with the rendering of HTML pages.
//
...
module Fake.StaticGen.Html.ViewEngine
...
let renderHtmlDocument (document : XmlNode) : string =
    let sb = StringBuilder().AppendLine("<!DOCTYPE html>")
    ViewBuilder.buildHtmlNode sb document
    sb.ToString()
